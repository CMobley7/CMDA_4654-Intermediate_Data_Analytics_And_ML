...
# Load Cleaned Data
subway_data = read.csv("data_set_2.csv")

# Create Data Frame
subway_data.frame = data.frame(Y = subway_data$ENTRIESn_hourly, day_hour=subway_data$day_hour, weekday=subway_data$weekday, latitude = subway_data$latitude, longitude = subway_data$longitude, rain = subway_data$rain, fog = subway_data$fog, precipi = subway_data$precipi, pressurei = subway_data$pressurei, tempi = subway_data$tempi, wspdi = subway_data$wspdi)
...
points(bestsubset.model, mean.backward.test.adjr2[bestsubset.model], pch = 19, col = "red")
...
points(forward.model, mean.forward.test.adjr2[forward.model], pch = 20, col = "red")
...
points(backward.model, mean.backward.test.adjr2[backward.model], pch = 20, col = "red")
