...
# Load Cleaned Data
subway_data = read.csv("data_set_7.csv")

# Create Data Frame
subway_data.frame = data.frame(Y = subway_data$ENTRIESn_hourly, hour=subway_data$hour, day_week = subway_data$day_week, latitude = subway_data$latitude, longitude = subway_data$longitude, rain = subway_data$rain, fog = subway_data$fog, meanprecipi = subway_data$meanprecipi, meanpressurei = subway_data$meanpressurei, meantempi = subway_data$meantempi, meanwspdi = subway_data$meanwspdi)
